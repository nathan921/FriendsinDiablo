 ...
 */
public class FragmentCareerList extends ListFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        RecyclerView recList = (RecyclerView)getActivity().findViewById(R.id.careerList);
    ...
    public void onListItemClick(ListView l, View v, int position, long id) {
        String selectedHero = getListAdapter().getItem(position).toString();
    }

    private class CharacterListAdapter extends RecyclerView.Adapter<String> {
